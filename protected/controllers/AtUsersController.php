...
//			'postOnly + delete', // we only allow deletion via POST request
    ...
    public function actionRegistration() {
        if(isset($_SESSION) && isset($_SESSION['user_type']) && $_SESSION['user_type']=='Customer')
        {
            $this->redirect(array('profiledtls'));
            exit;
        }
        if(isset($_SESSION) && isset($_SESSION['user_type']) && $_SESSION['user_type']=='Partner')
        {
