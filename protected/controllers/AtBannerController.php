...
class AtBannerController extends Controller
{
	/**
...
//			'postOnly + delete', // we only allow deletion via POST request
	...
	public function actionIndex()
	{
              Yii::app()->theme = 'admin';
		$this->layout='adminmain';
		$dataProvider=new CActiveDataProvider('AtBanner');
	...
	public function actionAdmin()
	{
		...
		if(isset($_GET['AtBanner']))
			$model->attributes=$_GET['AtBanner'];
	 ...
	 * @return AtBanner the loaded model
	 * @throws CHttpException
	 */
	public function loadModel($id)
	{
		$model=AtBanner::model()->findByPk($id);
		if($model===null)
	 ...
	 * @param AtBanner $model the model to be validated
	 */
	protected function performAjaxValidation($model)
	{
		if(isset($_POST['ajax']) && $_POST['ajax']==='at-banner-form')
		{
