                ...
                <ul class="nav navbar-top-links navbar-right">
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-messages">
                            <li>
                                <a href="<?php echo Yii::app()->createUrl('mrClass/admin'); ?>">
                                    <div>
...
<!--                                            <em>Yesterday</em>-->
                                    ...
                                    <div>Click on "View Students" link.</div>
                                </a>
                            </li>
                            <li class="divider"></li>
                             <li>
                                 <a href="<?php echo Yii::app()->createUrl('site/dashboardsearch'); ?>">
                                     <div>
                                         <strong>Search</strong>
                                         <span class="pull-right text-muted"></span>
                                     </div>
                                     <div>Search with CDC/passport/Indos no.</div>
                                 </a>
                             </li>
...
<!--                    <li class="dropdown">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu dropdown-user">
                            ...
                            <li class="divider"></li>
                            <li><?php echo CHtml::link('<i class="fa fa-sign-out fa-fw"></i>Logout', array('site/logout'), array('class' => '')); ?>
