...
<?php  
	  ...
	  $cs->registerScriptFile($baseUrl.'/js/wmvplayer/silverlight.js');
	  $cs->registerScriptFile($baseUrl.'/js/wmvplayer/wmvplayer.js');
          
          $cs->registerScriptFile($baseUrl.'/js/common.js');
           $cs->registerScriptFile($baseUrl.'/js/jquery.validationEngine.js');
           $cs->registerScriptFile($baseUrl.'/js/languages/jquery.validationEngine-en.js');
           $cs->registerCssFile($baseUrl.'/css/validationEngine.jquery.css');
	  ?>
